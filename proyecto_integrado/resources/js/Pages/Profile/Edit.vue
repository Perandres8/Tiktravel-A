...
<!--  -->
<div class="flex justify-center" v-if="$page.props.auth.user.id!=2">
    <div class="w-full flex max-w-5xl space-x-5">
            ...
            <ul class="mt-2 text-gray-700">
                ...
                <li class="flex items-center border-b py-2 space-x-2">
                    ...
                    <a href="#" title="Facebook">
                        <svg class="w-5 h-5" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 506.86 506.86">
        ...
        <div class="flex-1 bg-white rounded-lg shadow-xl p-8 text-center">
...
<div class="bg-white rounded-lg shadow-xl p-8" v-if="$page.props.auth.user.id!=2">
